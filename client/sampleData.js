...
export const PODSDATA = [
    {
      ...
      CPU: 0.04005346,
      'MEMORY(bytes)': 0.8099888392857143
    },
    {
      POD: 'etcd-minikube',
      CPU: 0.56822157,
      'MEMORY(bytes)': 1.70078125
    },
    {
    ...
    { POD: 'kube-proxy-97fpl', CPU: 0, 'MEMORY(bytes)': 0 },
    {
    ...
    },
    {
      ...
      'MEMORY(bytes)': 0.27107421875
    },
    { POD: 'storage-provisioner', CPU: 0, 'MEMORY(bytes)': 0 }
]

export const NAMESPACES = ['default',
'kube-node-lease',
'kube-public',
'kube-system',
